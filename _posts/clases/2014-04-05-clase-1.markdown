...
<div class="page-header"><h3 class="section-anchor" id="versionado">Versionado</h3></div>
...
Para subir nuestro trabajo a [Github][] (si no lo tenés) creá un usuario y
seguí las instrucciones de configuración. Después ejecutá:

```console
$ git remote add origin git@github.com:rubyutn/foro.git
$ git push -u origin master
```

[Github]: https://github.com/

<div class="page-header"><h3 class="section-anchor" id="resumen">Resumen</h3></div>
